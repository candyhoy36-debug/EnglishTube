...
public class DictionaryBottomSheet extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Body of the sheet is non-draggable so the inner WebView keeps
        // its scroll. The explicit close (X) button is the simple,
        // always-visible way to dismiss the sheet.
